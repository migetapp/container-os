...
| **Containerd** | 2.2.4-1\~ubuntu.22.04\~jammy | - | 2.2.4-1\~ubuntu.24.04\~noble | - | 1.7.10-r3 | - | 1.7.17-r2 | - | 2.0.0-r5 | - | 2.1.5-r2 | - |
...
- **Alpine 3.19 dockerd**
  ...
  `1.0.23-alpine-3.19.9-dockerd`, `1.0.23-alpine3.19-dockerd`, `1.0.23-alpine3.19`, `alpine3.19`, `stable-alpine3.19-dockerd`
  ([`dockerfiles/alpine/3.19/dockerd.Dockerfile`](dockerfiles/alpine/3.19/dockerd.Dockerfile))

- **Alpine 3.19 podman**

  `1.0.23-alpine-3.19.9-podman`, `1.0.23-alpine3.19-podman`, `stable-alpine3.19-podman`
  ([`dockerfiles/alpine/3.19/podman.Dockerfile`](dockerfiles/alpine/3.19/podman.Dockerfile))

- **Alpine 3.20 dockerd**

  `1.0.23-alpine-3.20.10-dockerd`, `1.0.23-alpine3.20-dockerd`, `1.0.23-alpine3.20`, `alpine3.20`, `stable-alpine3.20-dockerd`
  ([`dockerfiles/alpine/3.20/dockerd.Dockerfile`](dockerfiles/alpine/3.20/dockerd.Dockerfile))

- **Alpine 3.20 podman**

  `1.0.23-alpine-3.20.10-podman`, `1.0.23-alpine3.20-podman`, `stable-alpine3.20-podman`
  ([`dockerfiles/alpine/3.20/podman.Dockerfile`](dockerfiles/alpine/3.20/podman.Dockerfile))

- **Alpine 3.21 dockerd**

  `1.0.23-alpine-3.21.7-dockerd`, `1.0.23-alpine3.21-dockerd`, `1.0.23-alpine3.21`, `alpine3.21`, `stable-alpine3.21-dockerd`
  ([`dockerfiles/alpine/3.21/dockerd.Dockerfile`](dockerfiles/alpine/3.21/dockerd.Dockerfile))

- **Alpine 3.21 podman**

  `1.0.23-alpine-3.21.7-podman`, `1.0.23-alpine3.21-podman`, `stable-alpine3.21-podman`
  ([`dockerfiles/alpine/3.21/podman.Dockerfile`](dockerfiles/alpine/3.21/podman.Dockerfile))

- **Alpine 3.22 dockerd**

  `1.0.23-alpine-3.22.4-dockerd`, `1.0.23-alpine3.22-dockerd`, `1.0.23-alpine3.22`, `alpine3.22`, `latest-alpine`, `stable-alpine3.22-dockerd`
  ([`dockerfiles/alpine/3.22/dockerd.Dockerfile`](dockerfiles/alpine/3.22/dockerd.Dockerfile))

- **Alpine 3.22 podman**

  `1.0.23-alpine-3.22.4-podman`, `1.0.23-alpine3.22-podman`, `stable-alpine3.22-podman`
  ([`dockerfiles/alpine/3.22/podman.Dockerfile`](dockerfiles/alpine/3.22/podman.Dockerfile))

- **Ubuntu 22.04 dockerd**

  `1.0.23-ubuntu-22.04-dockerd`, `1.0.23-ubuntu22-dockerd`, `1.0.23-ubuntu22`, `ubuntu22`, `stable-ubuntu22-dockerd`
  ([`dockerfiles/ubuntu/22.04/dockerd.Dockerfile`](dockerfiles/ubuntu/22.04/dockerd.Dockerfile))

- **Ubuntu 22.04 podman**

  `1.0.23-ubuntu-22.04-podman`, `1.0.23-ubuntu22-podman`, `stable-ubuntu22-podman`
  ([`dockerfiles/ubuntu/22.04/podman.Dockerfile`](dockerfiles/ubuntu/22.04/podman.Dockerfile))

- **Ubuntu 24.04 dockerd**

  `1.0.23-ubuntu-24.04-dockerd`, `1.0.23-ubuntu24-dockerd`, `1.0.23-ubuntu24`, `ubuntu24`, `latest`, `stable-ubuntu24-dockerd`
  ([`dockerfiles/ubuntu/24.04/dockerd.Dockerfile`](dockerfiles/ubuntu/24.04/dockerd.Dockerfile))

- **Ubuntu 24.04 podman**

  `1.0.23-ubuntu-24.04-podman`, `1.0.23-ubuntu24-podman`, `stable-ubuntu24-podman`
